...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        # set command
        "set_usage":       "Usage: /set KEY VALUE\nKeys: backend | workers | parallel-backends | fallback-backends | log-level | model BACKEND MODEL | review-mode | review-backend",
        "set_unknown_key": "Unknown key {key!r}. Valid: backend | workers | parallel-backends | fallback-backends | log-level | model | review-mode | review-backend",
        "set_ok":          "✓ {key} = {value}",
        "set_bad_backend": "Unknown backend {backend!r}. Use: claude | codex | opencode",
        "set_bad_workers": "workers must be a positive integer",
        "set_bad_loglevel": "log-level must be: DEBUG | INFO | WARNING | ERROR",
        "set_bad_review_mode": "review-mode must be: self | cross | backend",
        "set_config_error": "Failed to update config: {exc}",
        "config_not_init":  ".autopilot/config.toml not found — run /init first",
        "config_opening":   "Opening config in system editor…",
        "config_open_error": "Failed to open editor: {exc}",
    ...
    "zh": {
        ...
        # set command
        "set_usage":       "用法：/set KEY VALUE\n可用 Key：backend | workers | parallel-backends | fallback-backends | log-level | model BACKEND MODEL | review-mode | review-backend",
        "set_unknown_key": "未知参数 {key!r}，可用：backend | workers | parallel-backends | fallback-backends | log-level | model | review-mode | review-backend",
        "set_ok":          "✓ {key} = {value}",
        "set_bad_backend": "未知后端 {backend!r}，可选：claude | codex | opencode",
        "set_bad_workers": "workers 必须为正整数",
        "set_bad_loglevel": "log-level 必须为：DEBUG | INFO | WARNING | ERROR",
        "set_bad_review_mode": "review-mode 必须为：self | cross | backend",
        "set_config_error": "配置更新失败：{exc}",
        "config_not_init":  "未找到 .autopilot/config.toml — 请先执行 /init",
        "config_opening":   "正在用系统编辑器打开配置文件…",
        "config_open_error": "打开编辑器失败：{exc}",
        "reload_ok":        "✓ 配置已重载。",
